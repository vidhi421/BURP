    ...
    <div>
        ...
        style={{padding:"50px"}}>
            ...
            <Row>
                ...
                <Col md={6}>
                    <Form.Label>Cooking Time(in mins)</Form.Label>
                    <Form.Control 
            ...
            <p>(numbered list is preferred)</p>
            ...
            <Row>
                ...
                <Col md={2}>
                    <Form.Label>Fat(in gm)</Form.Label>
                    <Form.Control 
                ...
                <Col md={2}>
                    <Form.Label>Protein(in gm)</Form.Label>
                    <Form.Control 
                ...
                <Col md={2}>
                    <Form.Label>Carbs(in gm)</Form.Label>
                    <Form.Control 
                ...
                <Col md={2}>
                    <Form.Label>Sugar(in gm)</Form.Label>
                    <Form.Control 
                ...
                <Col md={2}>
                    <Form.Label>Fibre(in gm)</Form.Label>
                    <Form.Control 
